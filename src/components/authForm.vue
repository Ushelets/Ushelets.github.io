        ...
        <transition name="component-fade">
            <form class="sign-in-form" v-show="showSignInForm">
                <div class="input-group">
                    ...
                    <input id="emailIn" type="email" class="input" required/>
                </div>
                <div class="input-group">
                    <label for="passIn" class="label">Пароль</label>
                    <input id="passIn" type="password" class="input" data-type="password" required/>
                </div>
        ...
        <transition name="component-fade">
            <form class="sign-up-form" v-show="showSignUpForm">
                <div class="input-group">
                    ...
                    <input id="emailUp" type="email" class="input" required/>
                </div>
                <div class="input-group">
                    <label for="passUp" class="label">Пароль</label>
                    <input id="passUp" type="password" class="input" data-type="password" required/>
                </div>
                <div class="input-group">
